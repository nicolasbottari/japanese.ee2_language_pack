...
'ipn_details' => 
' IPNは、PayPalサービスの1つで、サイト上でトランザクション処理を許可し、トランザクションが終了し承認されたときにExpressionEngineに通知します。これによって、トランザクションが完了するまで購入（物）がシンプルコマースモジュールで保存、記録されないようにします。ExpressionEngineのシンプルコマースモジュールは舞台裏でこのすべてを自動化するので、PayPalサイトでIPNを有効にするだけです。また下記URLを提供します。<br /><br /> 詳細は下記を参照してください。https://www.paypal.com/IntegrationCenter/ic_ipn.html',
